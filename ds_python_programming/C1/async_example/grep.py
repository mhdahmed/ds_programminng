...
# yield() is used to suspend the execution of the coroutine
# send() is used to pass data to a coroutine (and hence resume its execution)
# close() is ued to terminate a coroutine

# decorator that implements the next()
def coroutine(fn):
